  ...
  return (
    <>
      <section
        ...
        style={{
          background:
            "linear-gradient(160deg,#fefcf7 0%,#fdf8ee 40%,#fefaf3 100%)",
        }}
      >
        <div className="absolute inset-0 pointer-events-none">
          <div
            className="about-orb absolute rounded-full"
            style={{
              width: 500,
              height: 500,
              top: -120,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
          {/* Header */}
          <div
            className={`text-center mb-16 ${visible ? "reveal-up" : "opacity-0"}`}
          >
            <div
            ...
            >
              {t("about.heading_plain")}{" "}
              <span className="text-gold-grad">{t("about.heading_gold")}</span>
            </h2>
            <p
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            {/* Pillars */}
            <div
              className={`flex flex-col gap-4 ${visible ? "reveal-right" : "opacity-0"}`}
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      boxShadow:
                        activeCard === p.id
                          ? "0 4px 18px rgba(212,168,67,0.32)"
                          : "none",
                    }}
                  >
                    {ICONS[p.id]}
                  ...
                  <div className="flex-1 min-w-0">
                    <h3
                      ...
                      style={{
                        color: activeCard === p.id ? "#92600d" : "#1f2937",
                      }}
                    >
                      {p.title}
                    </h3>
                    ...
                    >
                      <div
                        ...
                        style={{ width: activeCard === p.id ? "85%" : "0%" }}
                      />
                    </div>
                  </div>
                  <svg
                    ...
                    style={{
                      transition: "all 0.3s",
                      transform: activeCard === p.id ? "translateX(-3px)" : "",
                    }}
                  >
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg,rgba(255,255,255,0.95),rgba(253,248,238,0.95))",
              ...
              >
                ...
                <div className="mt-6 flex items-center gap-3">
                  <button
                    className="shimmer-btn inline-flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold border-0 cursor-pointer"
                    style={{ color: "#050d1f" }}
                  ...
                  <button
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold cursor-pointer border transition-all duration-200"
                    style={{
                      borderColor: "rgba(212,168,67,0.3)",
                      color: "#92600d",
                    ...
                    onClick={() =>
                      window.open("https://wa.me/201066335201", "_blank")
                    }
                  >
                    {t("about.cta_contact")}
                  </button>
              ...
              <div className="grid grid-cols-4 gap-3">
                {stats.map(({ n, s, label }) => (
                  <div
                    key={label}
                    className="stat-chip rounded-2xl py-4 px-3 text-center border"
                    style={{
                  ...
                  >
                    <div className="text-xl font-black leading-none mb-1 text-gold-grad">
                      {n}
                      {s}
                    </div>
                    <div
      ...
      {modalOpen && (
        <AboutModal cardId={activeCard} onClose={() => setModalOpen(false)} />
      )}
    </>
  );
}
