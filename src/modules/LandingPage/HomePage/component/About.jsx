      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            {/* Pillars */}
            <div className={`flex flex-col gap-4 ${visible ? "reveal-right" : "opacity-0"}`} style={{ animationDelay:"0.15s" }}>
              {pillars.map((p) => (
                <div key={p.id}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-bold text-base mb-1" style={{ color: activeCard === p.id ? "#92600d" : "#1f2937" }}>
                      {p.title}
                    </h3>
