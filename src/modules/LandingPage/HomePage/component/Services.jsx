...
export default function Services() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(160deg,#f4f6fb 0%,#f0f4fa 50%,#eef2f8 100%)",
      }}
    >
      {/* BG */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          className="srv-orb absolute rounded-full"
          style={{
            width: 620,
            height: 620,
            top: -200,
            right: -200,
            background:
              "radial-gradient(circle,rgba(212,168,67,0.065) 0%,transparent 70%)",
            filter: "blur(72px)",
          }}
        />
        <div
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle,rgba(212,168,67,0.065) 1px,transparent 1px)",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
        {/* Header */}
        <div
          className={`text-center mb-16 ${visible ? "srv-reveal" : "opacity-0"}`}
        >
          <div
          ...
          <h2
            ...
            style={{ fontSize: "clamp(28px,4vw,46px)", color: "#111827" }}
          >
          ...
          {items.map((svc, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Number */}
                <span
                  className="absolute top-5 left-6 text-5xl font-black select-none transition-all duration-300"
                  style={{
                    color: isHov
        ...
        {/* CTA */}
        <div
          className={`flex flex-col items-center mt-14 ${visible ? "srv-reveal" : "opacity-0"}`}
        ...
        >
          ...
          <a
            href="https://wa.me/201066335201"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button
              className="srv-cta-btn inline-flex items-center gap-3 px-8 py-3.5 rounded-xl text-[15px] font-bold border-0 cursor-pointer"
              style={{ color: "#050d1f" }}
            >
              <svg
                width="17"
