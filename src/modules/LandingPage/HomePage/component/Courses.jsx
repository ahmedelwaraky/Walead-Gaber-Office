...
export default function Courses() {
  ...
  return (
    <section id="courses" ref={ref} dir={dir}
      className="relative overflow-hidden py-28"
      style={{ background:"linear-gradient(160deg,#fefcf7 0%,#fdf8ee 100%)" }}
    >
      {/* BG */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="course-orb absolute rounded-full"
          style={{ width:500,height:500,bottom:-150,right:-150,background:"radial-gradient(circle,rgba(212,168,67,0.06) 0%,transparent 70%)",filter:"blur(65px)" }}/>
        <div className="course-orb absolute rounded-full"
          style={{ width:400,height:400,top:-100,left:-100,background:"radial-gradient(circle,rgba(212,168,67,0.05) 0%,transparent 70%)",filter:"blur(55px)",animationDelay:"-4s" }}/>
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">

        {/* Header */}
        <div className={`text-center mb-12 ${visible ? "course-reveal" : "opacity-0"}`}>
          ...
          {items.map((course, i) => (
            ...
            >
              ...
              <div className="flex justify-center mb-4">
                <div className="course-icon w-14 h-14 rounded-2xl flex items-center justify-center"
              ...
              <button className="course-enroll w-full py-3 rounded-xl text-sm font-bold border-0 cursor-pointer"
                style={{ color:"#050d1f" }}>
