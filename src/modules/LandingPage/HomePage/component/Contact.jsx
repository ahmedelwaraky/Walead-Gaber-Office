  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: "linear-gradient(rgba(15,36,83,0.07) 1px,transparent 1px),linear-gradient(90deg,rgba(15,36,83,0.07) 1px,transparent 1px)",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div
          className="contact-orb absolute rounded-full"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          {/* Info + Map */}
          <div
            className={`flex flex-col gap-4 ${visible ? "contact-reveal" : "opacity-0"}`}
            style={{ animationDelay: "0.1s" }}
          >
            {infoItems.map(({ id, label, values }, index) => (
              <div
                key={index}
                className="contact-info-card flex items-start gap-4 rounded-2xl border p-5"
                ...
                <div className="flex flex-col gap-1.5 min-w-0">
                  ...
                  {values.map((val, vi) => (
                    <div
                      ...
                      style={{ color: "#1f2937" }}
                      dir={LTR_IDS.includes(id) ? "ltr" : dir}
                    >
                      {values.length > 1 && id === "address" && vi > 0 && (
                        <div className="my-1.5 h-px w-full" style={{ background: "rgba(212,168,67,0.15)" }}/>
                      )}
                      {val}
                    </div>
                  ))}
          ...
          {/* Form */}
          <div
            className={`${visible ? "contact-reveal" : "opacity-0"}`}
