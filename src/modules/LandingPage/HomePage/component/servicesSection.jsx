...
const SERVICES = [
  {
    ...
    desc: "مراجعة وتدقيق الحسابات وفقًا لمعايير المراجعة الدولية",
    icon: (
  ...
  },
  {
    ...
    desc: "تقديم استشارات ضريبية متخصصة وإعداد الإقرارات الضريبية",
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: "إعداد القوائم المالية وإمساك الدفاتر المحاسبية وفقًا للمعايير الدولية",
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    tag: "دراسات",
    title: "دراسات الجدوى",
    desc: "إعداد دراسات الجدوى الاقتصادية والمالية للمشاريع الجديدة",
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    desc: "تقديم حلول مالية متكاملة لتحسين الأداء المالي للمؤسسات",
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    tag: "تأسيس",
    title: "تأسيس الشركات",
    desc: "خدمات تأسيس الشركات وإعداد عقود التأسيس والأنظمة الأساسية",
    icon: (
      <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <>
      <style>{`
        ...
        .srv-reveal { animation:srvReveal 0.65s ease both; }
        .srv-scale  { animation:srvScale  0.6s  ease both; }
        .srv-orb    { animation:srvOrb    9s ease-in-out infinite; }
        ...
        .srv-card::before {
          ...
          background:linear-gradient(135deg,rgba(212,168,67,0.07) 0%,transparent 65%);
          opacity:0; transition:opacity 0.36s ease;
        }
        .srv-card:hover { transform:translateY(-7px) !important; }
        ...
        .srv-card:hover .srv-shimmer { animation:srvShimmer 0.9s ease forwards; }

        .srv-icon-box { transition:all 0.36s ease; }
        .srv-card:hover .srv-icon-box { animation:iconPop 0.5s ease forwards; }
        ...
        .srv-card:hover .srv-bottom-line { transform:scaleX(1); }

        .srv-learn { transition:all 0.3s ease; }
        .srv-learn svg { transition:transform 0.3s ease; }
        .srv-card:hover .srv-learn { color:#d4a843 !important; }
        .srv-card:hover .srv-learn svg { transform:translateX(-5px); }

        .srv-tag { transition:all 0.28s ease; }
        .srv-card:hover .srv-tag {
          background:rgba(212,168,67,0.16) !important;
          border-color:rgba(212,168,67,0.4) !important;
          color:#8a560a !important;
        }

        .srv-cta-btn {
          background:linear-gradient(135deg,#d4a843,#f0c96a);
          box-shadow:0 6px 26px rgba(212,168,67,0.36);
          transition:all 0.3s ease;
        }
        .srv-cta-btn:hover { transform:translateY(-2px); box-shadow:0 10px 36px rgba(212,168,67,0.52); }
      `}</style>
      ...
      <section
        ...
        style={{ background:"linear-gradient(160deg,#fdf9f2 0%,#fefcf5 50%,#faf6ec 100%)" }}
      >
        {/* ── BG Decoration ── */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className={`text-center mb-16 ${visible?"srv-reveal":"opacity-0"}`}>
            ...
            <h2 className="font-black mb-4" style={{ fontSize:"clamp(28px,4vw,46px)", color:"#111827" }}>
              خدما
              <span style={{ background:"linear-gradient(135deg,#b8761e,#d4a843,#f0c96a)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", backgroundClip:"text" }}>تنا</span>
            </h2>

            <p className="text-[15px] max-w-sm mx-auto leading-relaxed" style={{ color:"#6b7280" }}>
              نقدم مجموعة شاملة من الخدمات المهنية المتخصصة
            </p>
            ...
            {SERVICES.map((svc, i) => {
              ...
              return (
                <div
                  ...
                  style={{
                    background: isHov
                      ? "linear-gradient(145deg,rgba(255,255,255,0.98),rgba(253,248,238,0.98))"
                      : "rgba(255,255,255,0.9)",
                    borderColor: isHov ? "rgba(212,168,67,0.38)" : "rgba(212,168,67,0.13)",
                    backdropFilter: "blur(14px)",
                    boxShadow: isHov
                      ? "0 22px 64px rgba(0,0,0,0.1), 0 0 0 1px rgba(212,168,67,0.15)"
                ...
                >
                  ...
                  {/* Icon */}
                  <div
                    className="srv-icon-box w-16 h-16 rounded-2xl flex items-center justify-center mb-5"
                    style={{
                      background: isHov
                        ? "linear-gradient(135deg,#d4a843,#f0c96a)"
                        : "linear-gradient(135deg,#0c1d40,#1a3a70)",
                      color: isHov ? "#fff" : "#d4a843",
                      boxShadow: isHov
                        ? "0 8px 30px rgba(212,168,67,0.38)"
                        : "0 4px 18px rgba(15,36,83,0.28)",
                    }}
                  >
                    {svc.icon}
                  </div>
                  ...
                  {/* Tag */}
                  <div
                    className="srv-tag inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-semibold mb-3 border"
                  ...
                  {/* Title */}
                  <h3
                    className="font-black text-xl mb-3 leading-tight transition-colors duration-300"
                  ...
                  {/* Desc */}
                  <p className="text-sm leading-7 flex-1" style={{ color:"#6b7280" }}>
                    {svc.desc}
                  </p>

                  {/* Learn more */}
                  <div
                    className="srv-learn flex items-center gap-2 mt-6 text-xs font-bold"
          ...
          <div className={`flex flex-col items-center mt-14 ${visible?"srv-reveal":"opacity-0"}`}
            ...
            <p className="text-sm mb-5" style={{ color:"#9ca3af" }}>
              هل تحتاج إلى خدمة مخصصة؟ فريقنا جاهز لمساعدتك
            </p>
            <button
              className="srv-cta-btn font-tajawal inline-flex items-center gap-3 px-8 py-3.5 rounded-xl text-[15px] font-bold border-0 cursor-pointer"
              style={{ color:"#050d1f" }}
            >
